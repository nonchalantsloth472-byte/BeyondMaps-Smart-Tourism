...
function Safety() {
  ...
  const playSiren = (
    ...
    // Rising and falling siren sweep
  ...
  const activateEmergency = () => {
    ...
    // Play a longer siren immediately
    playSiren();

    // Repeat the siren while emergency is active
                    ...
                    <div className="grid grid-cols-2 gap-x-6 gap-y-4">
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <Navigation
                          size={15}
                          strokeWidth={1.75}
                          className="text-[#234236] mt-0.5"
                        />

                        <div>
                          <p className="text-[10px] uppercase tracking-[0.14em] text-[#6F6A61]">
                            Location
                          </p>

                          <p className="text-sm text-[#24231F] mt-0.5">
                      ...
                      <div className="flex items-start gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-[#8f2f24] mt-0.5">
                            Active
                          </p>
                        </div>
                ...
                <ul className="space-y-4">
                  ...
                  {CHECKLIST.map((item) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-[#24231F] leading-relaxed">
                        {item}
                      </span>
